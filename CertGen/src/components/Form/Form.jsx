...
function Form() {
  ...
  return (
    <div className="flex flex-col gap-5 text-primary justify-center items-center relative">
      ...
      {sampleMode && <Sample sample={sample} setSampleMode={setSampleMode} />}
      <Button
        variant="contained"
        component="label"
      ...
      <Button
        variant="contained"
        component="label"
        startIcon={csvFile.url ? <CheckCircleIcon /> : <BackupTableIcon />}
      ...
      <Button
        variant="contained"
        component="label"
        startIcon={font.url ? <CheckCircleIcon /> : <FontDownloadIcon />}
        color={font.url ? 'success' : 'primary'}
      >
        Font File
        <input type="file" name="fontFile" onChange={handleFontUpload} hidden />
      </Button>
      <Input
        type="number"
        required
      ...
      >
        ...
        <Button
          variant="contained"
          color={
            coords.xcoord === 0 && coords.ycoord === 0 ? 'primary' : 'success'
          }
